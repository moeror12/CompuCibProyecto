    ...
    public class DetalleOrdenService : IDetalleOrdenService
    {
        ...
        public int ActualizarDetalleOrden(DetalleOrden d)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                try
                {
                    string sql = $"Update DetalleOrden set nomProducto  = '{d.nomProducto}',Precio  = '{d.Precio}',IdOrden  = '{d.IdOrden}' WHERE IdDetalleOrden = {d.IdDetalleOrden}";
        ...
        public List<DetalleOrden> ListarDetalleOrden()
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                try
                {
                    string sql = "select  d.IdDetalleOrden, d.nomProducto, d.Precio, d.IdOrden from DetalleOrden d;";
        ...
        public DetalleOrden ObtenerDetalleOrden(int detalleOrdenId)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                try
                {
                    string sql = $"select  d.IdDetalleOrden, d.nomProducto, d.Precio, d.IdOrden from DetalleOrden d Where d.IdDetalleOrden={detalleOrdenId}";
        ...
        public int RegistrarDetalleOrden(List<DetalleOrden> d)
        {
            ...
            foreach (DetalleOrden det in d.ToList())
            {
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    try
                    {
                        string sql = $"INSERT INTO DetalleOrden (nomProducto, Precio,IdOrden) values ('{det.nomProducto}','{det.Precio}','{det.IdOrden}')";
                        SqlCommand cmd = new SqlCommand(sql, connection)
                        {
                            CommandType = CommandType.Text,
                        };
